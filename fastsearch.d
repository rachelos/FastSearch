...
# Description: Startup script for fastsearch on Debian. Place in /etc/init.d and
# run 'update-rc.d -f fastsearch defaults', or use the appropriate command on your
# distro. For CentOS/Redhat run: 'chkconfig --add fastsearch'

### BEGIN INIT INFO
#  
# Provides:         fastsearch.d
# Required-Start:   $local_fs  $remote_fs  
# Required-Stop:    $local_fs  $remote_fs  
# Default-Start:    2 3 4 5
# Default-Stop:     0 1 6
# Short-Description: starts fastsearch
# Description:       This file should be used to fastsearch scripts to be placed in /etc/init.d.  
#  
### END INIT INFO 
...
PROG_ARGS="--config=/fastsearch/config.yaml"
PID_PATH="/var/run/"
